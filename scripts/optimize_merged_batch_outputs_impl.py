...
def main():
    ap = argparse.ArgumentParser(description='Optimize merged batch AOI outputs into organized PNG/table views')
    ...
    cmd = [sys.executable, target, '--aoi_class_csv', class_csv, '--group_manifest', args.group_manifest, '--group_id_col', args.group_id_col, '--outdir', outdir]
