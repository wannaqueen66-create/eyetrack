...
TEXT = """# Main-branch Writing Guide (eyetrack)
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Generate a lightweight manuscript writing guide for eyetrack main")
    ap.add_argument("--out-dir", type=Path, default=Path("docs"))
    args = ap.parse_args()
    args.out_dir.mkdir(parents=True, exist_ok=True)
    out = args.out_dir / "MAIN_BRANCH_WRITING_GUIDE.md"
